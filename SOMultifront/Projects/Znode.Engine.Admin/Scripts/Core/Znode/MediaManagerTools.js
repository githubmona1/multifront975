var MediaManagerTools = /** @class */ (function () {
    ...
    MediaManagerTools.prototype.multiDownload = function (urls, fileNames) {
    ...
    MediaManagerTools.prototype.SaveToDisk = function (url, fileName) {
        fetch(url)
    ...
    MediaManagerTools.prototype.DownloadMedia = function () {
