...
var ProductAttribute = /** @class */ (function (_super) {
    ...
    ProductAttribute.prototype.Init = function () {
    ...
    ProductAttribute.prototype.BindDefaultValueSaveClick = function () {
    ...
    ProductAttribute.prototype.ShowDefaultValueEditMode = function (indexId, buttonObj) {
    ...
    //Show default value row in edit mode.
    ProductAttribute.prototype.ShowDefaultValueCancelMode = function (indexid, buttonObj) {
    ...
    ProductAttribute.prototype.ValidateAndSaveDefaultAttributeValue = function (indexid, buttonObj) {
    ...
    ProductAttribute.prototype.GetDefaultValueLocaleValueArray = function (indexid) {
        var _defaultValues = [];
    ...
    ProductAttribute.prototype.BindDefaultValueDeleteClick = function () {
    ...
    ProductAttribute.prototype.ValidationView = function () {
        ProductAttribute.prototype.ShowHideDefaultView();
    ...
    ProductAttribute.prototype.AddNewRow = function (jsonArray) {
    ...
    ProductAttribute.prototype.ShowHideIsRequired = function () {
    ...
    ProductAttribute.prototype.ShowhideFieldForAttributeTypeLink = function () {
        var attributetype = $("#attributeTypeList option:selected").text();
    ...
    ProductAttribute.prototype.ShowHideIsConfigurable = function () {
        var attributetype = $("#attributeTypeList option:selected").text();
    ...
    ProductAttribute.prototype.ShowHideIsPersonisable = function () {
        var attributetype = $("#attributeTypeList option:selected").text();
    ...
    ProductAttribute.prototype.ShowHideIsFacets = function () {
        var attributetype = $("#attributeTypeList option:selected").text();
    ...
    ProductAttribute.prototype.ShowHideDefaultView = function () {
        var attributetype = $("#attributeTypeList option:selected").text();
    ...
    ProductAttribute.prototype.DeletePIMAttribute = function (control, controllerName) {
    ...
    ProductAttribute.prototype.ValidateDefaultValue = function (indexid, defaultvalueCode, swatchText, mediaId) {
        var attributetype = $("#attributeTypeList option:selected").text();
    ...
    ProductAttribute.prototype.DeleteDefaultAttributeValue = function (element) {
    ...
    ProductAttribute.prototype.ShowHideAttributeGroupsSelection = function () {
    ...
    ProductAttribute.prototype.ValidationLocale = function (LocaleName) {
    ...
    ProductAttribute.prototype.Validate = function () {
        var Locales = [];
    ...
    ProductAttribute.prototype.ShowhideIsAllowMultiUploadforImage = function () {
    ...
    ProductAttribute.prototype.ShowHidedefaultValueField = function () {
        var attributeType = $("#attributeTypeList option:selected").text();
    ...
    ProductAttribute.prototype.ValidateNumberDefaultValue = function () {
    ...
    //Validate default date value.
    ProductAttribute.prototype.ValidateDateDefaultValue = function () {
    ...
    ProductAttribute.prototype.BetweenNumber = function (first, last) {
    ...
    ProductAttribute.prototype.BetweenDate = function (first, last, defaultValue) {
    ...
    ProductAttribute.prototype.IsDefaultValueCodeExist = function (defaultvalueCode, defaultvalueId) {
        var isExiest = false;
    ...
    ProductAttribute.prototype.SetYesNoControlValueFalse = function (controlId) {
        $("#" + controlId + "_left").prop("checked", "false");
        $("#" + controlId + "_right").prop("checked", "true");
    };
    ProductAttribute.prototype.ShowHideSwatchDivAccordingToSwatchType = function () {
    ...
    ProductAttribute.prototype.AutplayRequiredOnClick = function () {
    ...
    ProductAttribute.prototype.ShowHideSwatch = function () {
    ...
    ProductAttribute.prototype.CheckMediaBrowse = function (rowSwatchIndex) {
    ...
    ProductAttribute.prototype.IsSearchFieldEmtpty = function (control) {
    ...
    ProductAttribute.prototype.ScrollToElementById = function (elementId, scrollOverTime) {
        $('html, body').animate({
