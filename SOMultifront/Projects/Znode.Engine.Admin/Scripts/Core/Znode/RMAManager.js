...
var RMAManager = /** @class */ (function (_super) {
    __extends(RMAManager, _super);
    function RMAManager() {
        var _this = _super.call(this) || this;
        _this.subTax = 0;
        return _this;
    }
    RMAManager.prototype.Init = function () {
        RMAManager.prototype.CalculateSubTotal();
        RMAManager.prototype.GetRMAItemTotal();
        RMAManager.prototype.RemoveRMAGridIcone();
    };
    RMAManager.prototype.GetRMAItemTotal = function () {
    ...
    RMAManager.prototype.CalculateSubTotal = function () {
        $('#rmaGrid tbody td input:checkbox[name=IsReturnable]').on("click", function (e) {
            RMAManager.prototype.RMACalculation();
        });
    };
    RMAManager.prototype.CreateRMARequest = function () {
        ...
        var total = Number(subTotal.replace(/[^0-9\.]+/g, "")) + tax;
        var requestModel = {
            RMARequestId: 0,
    ...
    RMAManager.prototype.SelectAll = function () {
    ...
    RMAManager.prototype.GetGridData = function () {
        var items = new Array();
    ...
    RMAManager.prototype.RMACalculation = function () {
    ...
    //Print RMA Request
    RMAManager.prototype.PrintContent = function () {
    ...
    //To Do: Working on it.
    RMAManager.prototype.IssueGiftCard = function () {
    ...
    RMAManager.prototype.GetGiftCardGridData = function () {
        var items = new Array();
        var orderId = $("#OrderId").val();
        var subTotal = 0;
        $('#rmaGrid tr').not('thead tr').each(function () {
    ...
    RMAManager.prototype.RemoveRMAGridIcone = function () {
...
//# sourceMappingURL=RMAManager.js.map