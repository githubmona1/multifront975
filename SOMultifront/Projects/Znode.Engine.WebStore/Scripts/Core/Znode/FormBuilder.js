...
var FormBuilder = /** @class */ (function (_super) {
    ...
    FormBuilder.prototype.FormTemplateOnSuccess = function (data) {
    ...
    FormBuilder.prototype.SaveFormBuilder = function (backURL) {
    ...
    FormBuilder.prototype.ValidateDocument = function (control) {
        ZnodeBase.prototype.ShowLoader();
    ...
    FormBuilder.prototype.UploadMultipleDocument = function (control) {
    ...
    FormBuilder.prototype.UploadDocument = function (file, callback) {
    ...
    FormBuilder.prototype.labelClick = function (className, AttributeId) {
        if (className === "yes") {
    ...
    FormBuilder.prototype.IsAttributeValueUnique = function () {
        //check for other validations        
        var result = FormBuilder.prototype.Validate();
        ...
        var id = parseInt($("#FormBuilderId").val());
        var entityType = $("#FormCode").val();
    ...
    FormBuilder.prototype.ValidateNumberDefaultValue = function () {
    ...
    FormBuilder.prototype.IsValidateNumberLength = function (val) {
        var isNumeric = false;
        if (val != undefined) {
            if (val.length >= 13)
                isNumeric = true;
    ...
    FormBuilder.prototype.IsDecimalExist = function (p_decimalNumber) {
    ...
    //Validate default date value.
    FormBuilder.prototype.ValidateDateDefaultValue = function () {
    ...
    FormBuilder.prototype.BetweenNumber = function (first, last) {
        var defaultValue = $("#AttributeDefaultValue").val();
    ...
    FormBuilder.prototype.BetweenDate = function (first, last, defaultValue) {
    ...
    FormBuilder.prototype.ShowMessage = function (id, key) {
    ...
    FormBuilder.prototype.Validate = function () {
        ...
        if (isNaN(minNumber) && minNumber != undefined)
            return FormBuilder.prototype.ShowMessage("errorSpamMinNumber", "OnlyNumericallowforMaxNumber");
        if (FormBuilder.prototype.IsValidateNumberLength(minNumber))
            return FormBuilder.prototype.ShowMessage("errorSpamMinNumber", "OnlyNumericallowforMaxNumber");
        ...
        if (FormBuilder.prototype.IsValidateNumberLength(maxNumber))
            return FormBuilder.prototype.ShowMessage("errorSpamMaxNumber", "OnlyNumericallowforMaxNumber");
    ...
    //Method for Save Product
    FormBuilder.prototype.SaveEntityAttribute = function (backURL) {
        ZnodeBase.prototype.ShowLoader();
    ...
    FormBuilder.prototype.ValidateFileTypeControl = function () {
        var flag = false;
    ...
    FormBuilder.prototype.SetActiveGroup = function (group) {
