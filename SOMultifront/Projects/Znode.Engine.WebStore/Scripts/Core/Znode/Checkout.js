...
var Checkout = /** @class */ (function (_super) {
    ...
    Checkout.prototype.SelectShippingOption = function () {
    ...
    Checkout.prototype.SelectShippingOptionForAmaoznPay = function () {
    ...
    Checkout.prototype.ShippingOptions = function (isCalculateCart) {
    ...
    Checkout.prototype.GetOrderAndPaymentDetails = function (omsOrderId) {
    ...
    Checkout.prototype.GetOrderAndPaymentDetailsForInvoice = function (data) {
        data.attr("href", "#");
        var omsOrderId = (data.attr("data-parameter").split('=')[1]).split('&')[0];
        Checkout.prototype.GetOrderAndPaymentDetails(omsOrderId);
    };
    Checkout.prototype.MakePaymentAndGetOrderAndPaymentDetails = function () {
        var omsOrderId = $("#OmsOrderId").val();
        Checkout.prototype.GetOrderAndPaymentDetails(omsOrderId);
    };
    Checkout.prototype.SetOfflinePayment = function () {
    ...
    Checkout.prototype.SavedNewcart = function () {
    ...
    ;
    Checkout.prototype.SubmitOrderCheckout = function () {
    ...
    ;
    Checkout.prototype.ShippingErrorMessage = function (isLoaderHide) {
        if (isLoaderHide === void 0) { isLoaderHide = true; }
    ...
    Checkout.prototype.ShowHidePayPalButton = function () {
        var paymentOption = $("input[name='PaymentOptions']:checked").attr("id");
    ...
    Checkout.prototype.InvoiceMe = function () {
    ...
    Checkout.prototype.EnableButton = function () {
    ...
    Checkout.prototype.DisableButton = function () {
    ...
    Checkout.prototype.SetOrderFormData = function (data) {
    ...
    Checkout.prototype.ShowLoaderForExistingCustomerLogin = function () {
        if ($("#login_username").val() != "" && $("#login_password").val() != "") {
            $("#loader-content-backdrop-login").show();
        }
    };
    Checkout.prototype.DisableShippingForFreeShippingAndDownloadableProduct = function () {
    ...
    Checkout.prototype.CreateForm = function (data) {
        var form = $('<form/></form>');
    ...
    Checkout.prototype.AddFormFields = function (form, data) {
        if (data != null) {
    ...
    Checkout.prototype.CalculateShipping = function (ShippingclassName, isCalculateCart) {
        if (isCalculateCart === void 0) { isCalculateCart = true; }
        var form = $("#form0");
        if (form.length > 0) {
    ...
    Checkout.prototype.SetUserCreationStatusMessage = function (response) {
    ...
    Checkout.prototype.CheckDiscountCodeValue = function (codeType) {
        Checkout.prototype.ShowLoader();
        var discountCode = "";
        if (codeType == "coupon") {
    ...
    Checkout.prototype.DisplayAppliedDiscountCode = function (data) {
    ...
    Checkout.prototype.BindVoucherHtml = function (vouchers) {
        if (vouchers != null) {
            $("#RequiredgiftCardErrorMessage").html('');
    ...
    Checkout.prototype.RemoveDiscountMessages = function () {
    ...
    Checkout.prototype.DisablePaymentOnZeroOrderTotal = function () {
    ...
    Checkout.prototype.RemoveAppliedCoupon = function (couponIndex) {
        var _code = coupons[couponIndex].Code;
        coupons = new Array();
        Checkout.prototype.RemoveCoupon(_code);
    };
    Checkout.prototype.RemoveCoupon = function (code) {
        Checkout.prototype.ShowLoader();
    ...
    Checkout.prototype.RemoveGiftCard = function () {
        Checkout.prototype.ShowLoader();
    ...
    Checkout.prototype.RemoveVoucher = function (code) {
        Checkout.prototype.ShowLoader();
    ...
    Checkout.prototype.RemoveAppliedVoucher = function (voucherIndex) {
        var _code = vouchers[voucherIndex].VoucherNumber;
        vouchers = new Array();
        Checkout.prototype.RemoveVoucher(_code);
    };
    Checkout.prototype.SetAddressErrorNotificationMessage = function (data) {
        if (data.status) {
            if (data.error == "")
    ...
    Checkout.prototype.ToggleBillingAddressBlock = function () {
    ...
    Checkout.prototype.SaveChanges = function (event, id) {
        ...
        Endpoint.prototype.UpdateSearchAddress(addressViewModel, function (response) {
    ...
    Checkout.prototype.ShowPaymentOptions = function (data) {
        $("#errorPayment").html("");
        var paymentId = data;
    ...
    Checkout.prototype.ShowPaymentDetails = function (response, controlId) {
        if (!response.HasError) {
            $("#IsBillingAddressOptional").val(response.IsBillingAddressOptional);
            Checkout.prototype.SetPaymentDetails(response.Response);
    ...
    Checkout.prototype.CreditCardPaymentCyberSource = function (controlId) {
    ...
    Checkout.prototype.ShowACHPaymentDetails = function (response, controlId) {
        if (!response.HasError) {
            $("#IsBillingAddressOptional").val(response.IsBillingAddressOptional);
            Checkout.prototype.SetPaymentDetails(response.Response);
    ...
    Checkout.prototype.ShowHidePaymentOption = function (paymentType) {
        switch (paymentType.toLowerCase()) {
            case "cod":
                $("#div-CreditCard").hide();
                $("#div-PaypalExpress").hide();
    ...
    Checkout.prototype.SetPaymentDetails = function (response) {
        if (!response.HasError) {
    ...
    Checkout.prototype.ClearPaymentAndDisplayMessage = function (message) {
    ...
    Checkout.prototype.CanclePayment = function () {
    ...
    Checkout.prototype.SetCreditCardValidations = function () {
    ...
    Checkout.prototype.SubmitAuthorizePayment = function (querystr) {
        var Total = $("#Total").val();
    ...
    Checkout.prototype.SubmitPayment = function () {
        var Total = $("#Total").val();
        Total = Total.replace(',', '.');
        var paymentCode = $('#hdnGatwayName').val();
        if (Checkout.prototype.IsOrderTotalGreaterThanZero(Total)) {
    ...
    Checkout.prototype.SubmitCyberSourcePayment = function (querystr) {
        var Total = $("#Total").val();
        if (Checkout.prototype.IsOrderTotalGreaterThanZero(Total)) {
            var shippingId = $("#shipping-content").find("#AddressId").val();
            var billingId = $("#billing-content").find("#AddressId").val();
    ...
    Checkout.prototype.SubmitPaymentForACH = function () {
        var Total = $("#Total").val();
        Total = Total.replace(',', '.');
        var isValid = true;
        if (Checkout.prototype.IsOrderTotalGreaterThanZero(Total)) {
    ...
    Checkout.prototype.GetPaymentErrorMsg = function (response) {
    ...
    Checkout.prototype.SubmitQuotePayment = function (permissionCode) {
        var Total = $("#Total").val();
        Total = Total.replace(',', '.');
        if (Checkout.prototype.IsOrderTotalGreaterThanZero(Total)) {
            var isValid = true;
    ...
    Checkout.prototype.IsOrderTotalGreaterThanZero = function (total) {
    ...
    Checkout.prototype.Mod10 = function (ccNum) {
    ...
    Checkout.prototype.DetectCardTypeForCardConnect = function (number) {
    ...
    Checkout.prototype.DetectCardType = function (number) {
        var re = {
    ...
    Checkout.prototype.PayPalPaymentProcess = function () {
        var Total = $("#Total").val();
        var url = [];
        if (Checkout.prototype.IsOrderTotalGreaterThanZero(Total)) {
    ...
    Checkout.prototype.ValidateCreditCardDetails = function () {
        var isValid = true;
    ...
    Checkout.prototype.ValidateCyberSourceCardNameHolder = function () {
    ...
    Checkout.prototype.ValidateCyberSourceCard = function (event) {
    ...
    Checkout.prototype.ValidateCreditCardExpirationDetailsCyberSource = function (event) {
        ...
        if (!isValidMonth && !isValidYear && ((_b = (_a = event === null || event === void 0 ? void 0 : event.target) === null || _a === void 0 ? void 0 : _a.id) === null || _b === void 0 ? void 0 : _b.toLowerCase()) == "btncompletecheckout") {
            isValidCard = false;
        ...
        else if (!isValidMonth && ((((_d = (_c = event === null || event === void 0 ? void 0 : event.target) === null || _c === void 0 ? void 0 : _c.id) === null || _d === void 0 ? void 0 : _d.toLowerCase()) == "expmonth") || ((_f = (_e = event === null || event === void 0 ? void 0 : event.target) === null || _e === void 0 ? void 0 : _e.id) === null || _f === void 0 ? void 0 : _f.toLowerCase()) == "btncompletecheckout")) {
            isValidCard = false;
            $('#errorexpmonth').show();
            Checkout.prototype.PaymentErrorCyberSource("#expMonth");
        }
        else if (!isValidYear && ((((_h = (_g = event === null || event === void 0 ? void 0 : event.target) === null || _g === void 0 ? void 0 : _g.id) === null || _h === void 0 ? void 0 : _h.toLowerCase()) == "expyear") || ((_k = (_j = event === null || event === void 0 ? void 0 : event.target) === null || _j === void 0 ? void 0 : _j.id) === null || _k === void 0 ? void 0 : _k.toLowerCase()) == "btncompletecheckout")) {
            isValidCard = false;
            $('#errorexpyear').show();
            Checkout.prototype.PaymentErrorCyberSource("#expYear");
        }
    ...
    Checkout.prototype.ValidateCreditCardExpirationDetails = function (event) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        var isValidCard = true;
        var isValidMonth = true;
        var isValidYear = true;
        ...
        else if (!isValidMonth && ((((_d = (_c = event === null || event === void 0 ? void 0 : event.target) === null || _c === void 0 ? void 0 : _c.id) === null || _d === void 0 ? void 0 : _d.toLowerCase()) == "creditcardexpmonth") || ((_f = (_e = event === null || event === void 0 ? void 0 : event.target) === null || _e === void 0 ? void 0 : _e.id) === null || _f === void 0 ? void 0 : _f.toLowerCase()) == "btncompletecheckout")) {
            isValidCard = false;
            $('#errormonth').show();
            Checkout.prototype.PaymentError("exp-month");
        }
        else if (!isValidYear && ((((_h = (_g = event === null || event === void 0 ? void 0 : event.target) === null || _g === void 0 ? void 0 : _g.id) === null || _h === void 0 ? void 0 : _h.toLowerCase()) == "creditcardexpyear") || ((_k = (_j = event === null || event === void 0 ? void 0 : event.target) === null || _j === void 0 ? void 0 : _j.id) === null || _k === void 0 ? void 0 : _k.toLowerCase()) == "btncompletecheckout")) {
            isValidCard = false;
            $('#erroryear').show();
            Checkout.prototype.PaymentError("exp-year");
        }
    ...
    Checkout.prototype.ShowHideErrorCVV = function (isShow) {
        isShow ? $('#errorcvc').show() : $('#errorcvc').hide();
        isShow ? $('#errorcardnumber').show() : $('#errorcardnumber').hide();
    };
    Checkout.prototype.RemoveCreditCardValidationCSS = function (control) {
        $(control).css('border', '1px solid #c3c3c3');
        $(control).css('background', '');
    };
    Checkout.prototype.PaymentError = function (control) {
        $('input[data-payment=' + control + ']').css({
            "border": "1px solid red",
            "background": "#FFCECE"
        });
    };
    Checkout.prototype.PaymentErrorCyberSource = function (control) {
        $(control).css('border', '1px solid red');
        $(control).css('background', '#FFCECE');
    };
    Checkout.prototype.RemovePaymentErrorCyberSource = function (control) {
        $(control).css('border', '1px solid #c3c3c3');
        $(control).css('background', '');
    };
    Checkout.prototype.RemoveCreditCardValidationOnPaymentMethodChange = function () {
        $('#errornumber').hide();
        Checkout.prototype.RemoveCreditCardValidationCSS('input[data-payment="number"]');
        $('#errormonth').hide();
        $('#erroryear').hide();
    ...
    Checkout.prototype.SubmitForApproval = function () {
        var Total = $("#Total").val();
        Total = Total.replace(',', '.');
        if (Total != "" && Total != null && Total != 'undefined') {
            Total = Total.replace(',', '');
    ...
    Checkout.prototype.SubmitForDraft = function () {
    ...
    Checkout.prototype.DisplaySelectOptionMessage = function () {
    ...
    Checkout.prototype.CreateQuoteRedirectToReceipt = function (submitQuoteViewModel) {
    ...
    Checkout.prototype.CreateQuoteRedirectToHistory = function (submitQuoteViewModel) {
        Endpoint.prototype.CreateQuote(submitQuoteViewModel, function (response) {
            if (response.status) {
    ...
    Checkout.prototype.CreateQuoteRedirectToQuoteApprovalHistory = function (submitQuoteViewModel) {
    ...
    Checkout.prototype.GetPurchaseOrderHtml = function (paymentType) {
        var paymentSettingId = $("input[name='PaymentOptions']:checked").val();
    ...
    Checkout.prototype.SubmitCheckOutForm = function () {
        var data = {};
        //Get all the selected values required to submit order.
    ...
    Checkout.prototype.CheckValidPODocument = function () {
    ...
    Checkout.prototype.HidePONumberValidateMessage = function () {
        var purchaseOrderNumber = $('#txtPurchaseOrderNumber').val();
        if (purchaseOrderNumber != null) {
    ...
    Checkout.prototype.ShowGiftCardMessage = function () {
        if ($("#giftCard").val() != undefined && $("#giftCard").val().trim().length > 0
            ...
            var msg = $("#cartGiftCardMessage").val();
            var isGiftCardApplied = $("#cartGiftCardApplied").val();
        }
    };
    Checkout.prototype.AppendGiftCardMessage = function (msg, giftCardApplied, voucherIndex, voucherNumber, voucherName, expirationDate, voucherAmountUsed) {
        var htmlString = "<div class='col-xs-12 nopadding'>";
    ...
    Checkout.prototype.UploadPODocument = function (file, callback) {
    ...
    Checkout.prototype.RemovePoDocument = function (file, callback) {
        CommonHelper.prototype.GetAjaxHeaders(function (response) {
            var data = new FormData();
            $.ajax({
                type: "POST",
    ...
    Checkout.prototype.ShowPaymentLoader = function () {
        $("#Single-loader-content-backdrop").show();
    };
    Checkout.prototype.HidePaymentLoader = function () {
        $("#Single-loader-content-backdrop").hide();
    };
    Checkout.prototype.CreditCardPayment = function (controlId) {
    ...
    Checkout.prototype.AuthorizeIframeValidationsAndRendering = function (gatewayCode, shippingOptionValue, controlId) {
    ...
    Checkout.prototype.AuthorizeNetPayment = function (controlId) {
        $("#divAuthorizeNetIFrame").html('');
    ...
    Checkout.prototype.ACHPayment = function (controlId) {
        if ($("#hdnGatwayName").val() != undefined && $("#hdnGatwayName").val().length > 0) {
            var gatewayCode = $("#hdnGatwayName").val();
            $('#Save-credit-card').hide();
            $('#paymentProviders').hide();
    ...
    Checkout.prototype.GetCardConnectIframeCSS = function () {
    ...
    Checkout.prototype.GetACHCardConnectIframeCSS = function () {
    ...
    Checkout.prototype.Getiframe = function () {
        setTimeout(function () {
            $('#iframebody').show();
        }, 300);
    };
    Checkout.prototype.GetiframeACH = function () {
        setTimeout(function () {
            $('#iframebodyACH').show();
        }, 300);
    };
    //Validate CVV Code
    Checkout.prototype.ValidateCVV = function () {
    ...
    Checkout.prototype.ValidationOfCVV = function () {
    ...
    Checkout.prototype.BindEvent = function () {
    ...
    Checkout.prototype.RestrictCopyPasteEvent = function () {
    ...
    Checkout.prototype.AppendCVVHtml = function (event) {
    ...
    //Get CVV Code HTML
    Checkout.prototype.GetCVVHtml = function (cardtype) {
    ...
    //Get CVV Code HTML
    Checkout.prototype.GetCVVHtmlForAmericanExpress = function (cardtype) {
        if (cardtype === void 0) { cardtype = ""; }
    ...
    Checkout.prototype.ToggleCreditCardTab = function (show) {
    ...
    Checkout.prototype.ToggleACHAccountTab = function (show) {
    ...
    Checkout.prototype.AppendResponseToHTML = function (response) {
    ...
    Checkout.prototype.OnSavedCreditCardClick = function (cardNo) {
        $("#hdnCreditCardNumber").val(cardNo);
        Checkout.prototype.RemoveCreditCardValidationCSS('input[data-payment="cvv"]');
        Checkout.prototype.ClearNewlyAddedCreditCardDetailsOnToggle();
    };
    Checkout.prototype.OnSavedCreditCardClickCyberSource = function (cardNo, PaymentGUID) {
        $("#hdnCreditCardNumber").val(cardNo);
        $("#hdnPaymentGUID").val(PaymentGUID);
        Checkout.prototype.RemoveCreditCardValidationCSS('input[data-payment="cvv"]');
    };
    Checkout.prototype.CardConnectPayment = function (token) {
        $('#CardDataToken').val(token.message);
        $('#CardExpirationDate').val(token.expiry);
        $("#ErrorMessage").val(token.validationError);
    };
    Checkout.prototype.ValidateCardConnectDataToken = function () {
    ...
    Checkout.prototype.ErrorDisplayCyberSourcePayment = function () {
        if ($("#ErrorMessage").val() == "")
            $("#ErrorMessage").val(ZnodeBase.prototype.getResourceByKeyName("ErrorCardDetails"));
        ZnodeNotification.prototype.DisplayNotificationMessagesHelper($("#ErrorMessage").val(), "error", isFadeOut, fadeOutTime);
    };
    Checkout.prototype.ValidateCardConnectCardHolderName = function () {
    ...
    Checkout.prototype.OnSavedAchAccountClick = function (cardNo) {
        $("#hdnCreditCardNumber").val(cardNo);
        Checkout.prototype.RemoveCreditCardValidationCSS('input[data-payment="cvv"]');
        Checkout.prototype.ClearNewlyAddedCreditCardDetailsOnToggle();
    };
    Checkout.prototype.PayPalPayment = function () {
    ...
    Checkout.prototype.ClearNewlyAddedCreditCardDetailsOnToggle = function () {
    ...
    Checkout.prototype.ToggleFreeShipping = function () {
    ...
    Checkout.prototype.ShowPaymentProcessDialog = function () {
        $("#PaymentModal").modal({
            "backdrop": "static",
            "keyboard": true,
            "show": true
    ...
    Checkout.prototype.ShowPaypalPaymentProcessDialog = function () {
    ...
    Checkout.prototype.ShowAmazonPaymentProcessDialog = function () {
    ...
    Checkout.prototype.HideAmazonPaymentProcessDialog = function () {
        $(".modal-backdrop").remove();
        $("#AmazonPaymentModal").modal('hide');
        $("body").removeClass("modal-open");
    };
    Checkout.prototype.HidePaymentProcessDialog = function () {
        $(".modal-backdrop").remove();
        $("#PaymentModal").modal('hide');
        $("body").removeClass("modal-open");
    };
    Checkout.prototype.ShowErrorPaymentDialog = function (message) {
    ...
    Checkout.prototype.HideChangeAddressLink = function () {
        var accountId = $("#accountId").val();
        var roleName = $("#RoleName").val();
        var addressCount = $("#AddressCount").val();
        if ((roleName.toLowerCase() == "manager" || roleName.toLowerCase() == "user") && addressCount == 1 && accountId > 0) {
            $(".address-change").hide();
            $(".create-new-address").hide();
        }
    };
    //Disable fields, when Manager/ User changing address in checkout page.
    Checkout.prototype.DisableFields = function () {
        var roleName = $("#RoleName").val();
    ...
    Checkout.prototype.ChangeCartReviewSequence = function () {
        if ($("#allPaymentOptionsDiv").length == 0) {
            $('.shopping-cart .title span').text('4');
        }
    };
    Checkout.prototype.ScrollTop = function () {
        $(window).scrollTop(0);
        $(document).scrollTop(0);
    };
    Checkout.prototype.ModifyQuertyString = function () {
        var query = window.location.search.substring(1);
    };
    Checkout.prototype.PutDataIntoDatalayer = function (Data) {
        dataLayer.push(Data);
    };
    //AmazonPay Methods.
    //Call on change  on shipping and address.
    Checkout.prototype.CalculateAmazonShipping = function (ShippingclassName, amazonOrderReferenceId) {
        var form = $("#form0");
        var shippingOptionId = $("input[name='ShippingOptions']:checked").val();
        var shippingAddressId = $("#shipping-content").find("#AddressId").val();
        var shippingCode = $("input[name='ShippingOptions']:checked").attr("data-shippingCode");
    ...
    Checkout.prototype.AmazonShippingOptions = function (OrderReferenceId, paymentSettingId, total, accessToken, accountNumber, shippingMethod) {
        $("#loaderId").html(" <div class='loader-inner' style='margin:0 auto;text-align:center;padding:20px;'><img src= '../Content/Images/loading.svg' alt= 'Loading' class='dashboard-loader' /></div>");
    ...
    Checkout.prototype.AmazonPayOnReadyShippingCalculate = function (selectedShippingClassName) {
    ...
    Checkout.prototype.AmazonPayProcess = function (total, paymentSettingId, paymentCode) {
        var url = [];
        var shippingOptionValue = $("input[name='ShippingOptions']:checked").val();
        if ((shippingOptionValue == null || shippingOptionValue == "") && ($("#cartFreeShipping").val() != "True" || $("#hdnIsFreeShipping").val() != "True")) {
            ZnodeNotification.prototype.DisplayNotificationMessagesHelper(ZnodeBase.prototype.getResourceByKeyName("SelectShippingOption"), "error", isFadeOut, fadeOutTime);
    ...
    //Call :Amazon Pay
    Checkout.prototype.AmazonPayPayment = function (paymentSettingId, paymentCode) {
        var orderNumber = 0;
        Endpoint.prototype.GenerateOrderNumber(parseInt($("#hdnPortalId").val()), function (response) {
            orderNumber = response.orderNumber;
        });
    ...
    Checkout.prototype.GetPaymentType = function (id) {
    ...
    Checkout.prototype.ConvertQuoteToOrder = function () {
        var data = {};
        //Get all the selected values required to submit order.
    ...
    Checkout.prototype.ConvertQuoteToOrderCallbackQuoteList = function () {
        var data = {};
        //Get all the selected values required to submit order.
        Checkout.prototype.SetOrderDataFromQuote(data);
        //Create form to convert quote to order.
    ...
    Checkout.prototype.MultilevelApprove = function () {
        var data = {};
        //Get all the selected values required to submit order.
        Checkout.prototype.SetOrderDataFromQuote(data);
        //Create form to convert quote to order.
    ...
    Checkout.prototype.SetOrderDataFromQuote = function (data) {
    ...
    //Create form to convert quote to order.
    Checkout.prototype.ConvertToOrder = function (data) {
        var form = $('<form/></form>');
    ...
    //Create form to convert quote to order.
    Checkout.prototype.ConvertToOrderCallbackQuoteList = function (data) {
        var form = $('<form/></form>');
    ...
    //Create form to convert quote to order.
    Checkout.prototype.MultilevelApproveForm = function (data) {
        var form = $('<form/></form>');
    ...
    Checkout.prototype.SetFlagForApprovalRouting = function (isApprovalRequired, isOABRequired, isStoreLevelAppoverOn) {
        if (isStoreLevelAppoverOn == "true" || isApprovalRequired == "true" || isOABRequired == "true") {
            if (isOABRequired == "true")
                return true;
            else {
                var orderLimit = parseFloat($('#OrderLimit').val());
                var orderTotal = parseFloat($("#hdnTotalOrderAmount").val().replace(',', '.'));
    ...
    Checkout.prototype.GetLoginUserAddress = function () {
        var quoteId = parseInt($("#QuoteId").val());
        Endpoint.prototype.GetLoginUserAddress(0, quoteId, function (response) {
            $("#address-popup-content").html(response);
        });
    };
    Checkout.prototype.GetCartReview = function () {
    ...
    Checkout.prototype.BindAddToAddressBookCheckbox = function () {
    ...
    Checkout.prototype.IsCheckoutDataValidForAmazonPay = function () {
        var isValid = true;
        var paymentOptionValue = $("input[name='PaymentOptions']:checked").val();
        var shippingOptionValue = $("input[name='ShippingOptions']:checked").val();
        var isBillingAddresOptional = $("#IsBillingAddressOptional").val();
    ...
    Checkout.prototype.OnShippingAddressSelect = function (item) {
        var addressId = item.id;
        Checkout.prototype.ShowLoader();
        var isSuggestedAddress = false;
        Endpoint.prototype.GetAndSelectAddressDetails(addressId, "shipping", function (response) {
            Checkout.prototype.ShippingOptions();
    ...
    Checkout.prototype.OnBillingAddressSelect = function (item) {
        var addressId = item.id;
        Checkout.prototype.ShowLoader();
        var isSuggestedAddress = false;
        Endpoint.prototype.GetAndSelectAddressDetails(addressId, "billing", function (response) {
            Checkout.prototype.ShippingOptions();
            if (response.model != "" && typeof response.model != "undefined" && response.model != null) {
    ...
    Checkout.prototype.OnAddressSelectionCancel = function (addressId, addressType, userId) {
        $("#dvShippingOptions h3").next().html("<div id='loaderId'></div>");
        ZnodeBase.prototype.ShowLoader();
        var hostUrl = window.location.origin;
        setTimeout(function () { ZnodeBase.prototype.HideLoader(); }, 1000);
    ...
    Checkout.prototype.OnShippingAddressSelectionChange = function () {
    ...
    Checkout.prototype.RefreshAddressOptions = function (type, isCalculateCart) {
        if (isCalculateCart === void 0) { isCalculateCart = true; }
        Endpoint.prototype.RefreshAddressOptions(type, function (response) {
            if (type === "shipping") {
    ...
    Checkout.prototype.OnBillingAddressSelectionChange = function () {
    ...
    Checkout.prototype.SetReceipentNameAddressData = function (addressType) {
        if ($("." + addressType + "-address-content .address-block .address-recipient").length > 0) {
            ...
            var firstName = "";
            var lastName = "";
            var receipentName = $(receipentNameControl).val().trim();
            ...
            var addressUsername = Checkout.prototype.GetValueOrEmptyString(firstName.trim()) + " " + Checkout.prototype.GetValueOrEmptyString(lastName.trim());
    ...
    Checkout.prototype.SaveRecipientNameAddressData = function (addressType, callback) {
        if ($("#shipping-content .address-recipient").length > 0) {
            Checkout.prototype.ShowLoader();
            Endpoint.prototype.SetAddressRecipientNameInCart($("." + addressType + "-address-content .address-block .address-firstlastname").attr("data-address-fname"), $("." + addressType + "-address-content .address-block .address-firstlastname").attr("data-address-lname"), addressType, function (response) {
    ...
    Checkout.prototype.BindDisplayAddressData = function (addressModel, addressType) {
        var receipentNameControl = $("." + addressType + "-address-content .address-block .address-recipient");
        ...
        if (parseInt($('#QuoteId').val()) > 0) {
            ...
            if ((Checkout.prototype.GetValueOrEmptyString(addressModel.FirstName) + " " + Checkout.prototype.GetValueOrEmptyString(addressModel.LastName)).trim() == "") {
                ...
                $("." + addressType + "-address-content .address-block .address-firstlastname").html(Checkout.prototype.GetValueOrEmptyString($(".billing-address-content .address-block .address-firstlastname").attr("data-address-fname")) + " " +
                ...
                $("." + addressType + "-address-content .address-block .address-firstlastname").attr("data-address-fname", addressModel.FirstName);
                $("." + addressType + "-address-content .address-block .address-firstlastname").attr("data-address-lname", addressModel.LastName);
                $("." + addressType + "-address-content .address-block .address-firstlastname").html(Checkout.prototype.GetValueOrEmptyString(addressModel.FirstName) + " " +
        ...
        if ($(receipentNameControl).length > 0) {
            var recipientName = (Checkout.prototype.GetValueOrEmptyString(addressModel.FirstName) + " " + Checkout.prototype.GetValueOrEmptyString(addressModel.LastName)).trim();
            if (recipientName != "") {
                ...
                if (parseInt($('#QuoteId').val()) > 0) {
                    ...
                    $("." + addressType + "-address-content .address-block .address-firstlastname").html(Checkout.prototype.GetValueOrEmptyString($("." + addressType + "-address-content .address-shopper-firstname").val()) + " " +
        ...
        $("." + addressType + "-address-content .address-block .address-street").html(Checkout.prototype.GetValueOrEmptyString(addressModel.Address1) + "<br />" +
            Checkout.prototype.GetValueOrEmptyString(addressModel.Address2));
        $("." + addressType + "-address-content .address-block .address-citystate").html(Checkout.prototype.GetValueOrEmptyString(addressModel.CityName) + ", " +
    ...
    Checkout.prototype.GetValueOrEmptyString = function (value) {
    ...
    Checkout.prototype.ChangeSubmitOrderButtonText = function () {
    ...
    Checkout.prototype.IsCheckoutDataValid = function () {
        var Total = $("#Total").val();
        Total = Total.replace(',', '.');
        if (Total != "" && Total != null && Total != 'undefined') {
            Total = Total.replace(',', '');
    ...
    Checkout.prototype.prepareDataLayer = function (data) {
        var cartModel = {};
        var ecommerce = {};
        var purchase = {};
        var actionField = {};
    ...
    // Data Layer End
    Checkout.prototype.getValueForDataLayer = function (item) {
        var itemValue = item != undefined ? item : "";
        return itemValue;
    };
    Checkout.prototype.EditAddressSuccess = function () {
        if ($("#IsBillingAddressOptional").val() == "true") {
            $("#same-as-billing").hide();
        }
        else {
    ...
    Checkout.prototype.ShowHideBillingAddressDiv = function () {
    ...
    Checkout.prototype.ShowHideShippingAddressDiv = function () {
    ...
    Checkout.prototype.HideShippingDiv = function () {
        $("#shippingDiv").html("");
    };
    Checkout.prototype.HideVoucherHistoryGridColumn = function () {
        var indexOfRow = $('#grid tbody tr:eq(0)').find('.OrderId').index() + 1;
        var indexOfOmsUserId = $('#grid tbody tr:eq(0)').find('.OmsUserId').index() + 1;
    ...
    Checkout.prototype.LoadShippingOptionsOnCouponAction = function () {
        $("#loaderId").html(" <div class='loader-inner' style='margin:0 auto;text-align:center;padding:20px;'><img src= '../Content/Images/loading.svg' alt= 'Loading' class='dashboard-loader' /></div>");
        var isQuoteRequest = $('#IsQuoteRequest').val();
        var isPendingOrderRequest = $('#IsPendingOrderRequest').val();
        $("#shippingDiv").html("");
    ...
    Checkout.prototype.ValidateCustomerShipping = function () {
        if ($("#hndShippingclassName").val() != undefined && $("#hndShippingclassName").val() == Constant.ZnodeCustomerShipping && !($("#AccountNumber").val() == undefined || $("#AccountNumber").val() == "") && !($("#ShippingMethod").val() == undefined || $("#ShippingMethod").val() == "")) {
            $("#btnCompleteCheckout").attr("disabled", false);
            $("#errorAccountNumber").hide();
            $("#errorShippingMethod").hide();
    ...
    Checkout.prototype.BindOrderSummaryForOrder = function (data) {
        $("#summary-details").html(data.html);
    ...
    Checkout.prototype.HideAuthorizeIframe = function (IsIframeRenderInPopup) {
    ...
    Checkout.prototype.PaymentStoreApproval = function (userType, isApprovalRequired, isOABRequired, isStoreLevelAppoverOn, isStoreLevelApproverType, isNotGuest) {
        if (userType != "guest") {
            if (Checkout.prototype.SetFlagForApprovalRouting(isApprovalRequired, isOABRequired, isStoreLevelAppoverOn) && isNotGuest) {
    ...
    Checkout.prototype.BraintreeIframeValidationsAndRendering = function (gatewayCode, shippingOptionValue, controlId) {
        if ((shippingOptionValue == undefined) && ($("#QuoteId").val() == 0)) {
            ZnodeNotification.prototype.DisplayNotificationMessagesHelper(ZnodeBase.prototype.getResourceByKeyName("SelectShippingOption"), "error", isFadeOut, fadeOutTime);
            $("input:radio[name='PaymentOptions']").each(function (i) {
                this.checked = false;
    ...
    Checkout.prototype.BrainTreePayment = function (controlId) {
        $("#divAuthorizeNetIFrame").html('');
        var orderNumber = 0;
        if ($("#OrderNumber").val() == null || $("#OrderNumber").val() == undefined) {
            Endpoint.prototype.GenerateOrderNumber(parseInt($("#hdnPortalId").val()), function (response) {
    ...
    Checkout.prototype.SubmitBraintreeOrder = function (payload, isVault) {
    ...
    Checkout.prototype.ValidateBrainTreeCardDetails = function () {
    ...
    Checkout.prototype.HideModal = function () {
...
$("#CredidCardNumber").on("blur", function (event) {
    var CredidCardNumber = $('input[data-payment="number"]').val().split(" ").join("");
