var TreeView = /** @class */ (function () {
    ...
    TreeView.prototype.create = function () {
        var mediaStructureTree = $('#Main_Tree').jstree(true), selectedNode = mediaStructureTree.get_selected();
    ...
    TreeView.prototype.editCurrentNode = function (obj) {
    ...
    TreeView.prototype.rename = function () {
        var mediaStructureTree = $('#Main_Tree').jstree(true), selectedNode = mediaStructureTree.get_selected();
    ...
    TreeView.prototype.MediaRenameFolder = function (obj) {
    ...
    TreeView.prototype.share = function () {
        var mediaStructureTree = $('#Main_Tree').jstree(true), selectedNode = mediaStructureTree.get_selected();
        if (!selectedNode.length) {
            return false;
        }
    ...
    TreeView.prototype.RebindMediaStructureTreeData = function (updatedData) {
    ...
    TreeView.prototype.LoadTree = function () {
    ...
    TreeView.prototype.PopupTree = function () {
    ...
    TreeView.prototype.BindEvent = function () {
    ...
    TreeView.prototype.bindCurrentNode = function (e, data) {
        if (this._callBackCount === 0) {
            ...
            if ($('#isUploadPopup') != undefined && $('#isUploadPopup').val() == "true")
                displayMode = "Tile";
            var model = { "FolderId": id, "IsMultiSelect": true };
            var _newUrl;
            if (!isMediaPopup) {
    ...
    TreeView.prototype.setCurrentNode = function (e, data) {
    ...
    TreeView.prototype.ShareFolderWithUsers = function () {
        var accountIds = "";
    ...
    TreeView.prototype.IsFolderNameValid = function (selectedNode) {
    ...
    TreeView.prototype.ReloadTree = function () {
        $('#Main_Tree').jstree("destroy");
        TreeView.prototype.LoadTree();
        TreeView.prototype.BindEvent();
    };
    TreeView.prototype.SetRootFolder = function (data) {
        var i, j, r = [];
