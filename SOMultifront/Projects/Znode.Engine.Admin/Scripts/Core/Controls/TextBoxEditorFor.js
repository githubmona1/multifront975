...
var EditableText = /** @class */ (function (_super) {
    ...
    EditableText.prototype.labelClick = function (className, AttributeId) {
        if (className === "yes") {
    ...
    EditableText.prototype.EditControl = function (id) {
        $("#divEdit_" + id).hide();
    ...
    EditableText.prototype.HideControl = function (id) {
        var spamId = "";
    ...
    EditableText.prototype.SaveControl = function (obj) {
    ...
    EditableText.prototype.BrowseMedia = function (ImageId, IsMultiSelect, IsImageTag, IsDynamicControl, callback, IsFileTypeFilterRequired) {
        if (callback === void 0) { callback = ''; }
        if (IsFileTypeFilterRequired === void 0) { IsFileTypeFilterRequired = false; }
        var div = $("#divMediaUploaderPopup");
        var str = '<div id= "appendDiv" class="media-upload-panel"> </div>';
        div.html(str);
        ...
        var header = '<div class="col-sm-12 title-container">' +
            ...
            '</div>' +
            '  </div> ';
        var Type = IsFileTypeFilterRequired ? "MediaType" : "";
        var value;
        value = IsFileTypeFilterRequired ? $("input[id=hdn" + ImageId + "]").val() : "";
        var model = { "FolderId": -1, "IsMultiSelect": IsMultiSelect, "IsPopup": true, "Type": Type, "Value": value };
        $.ajax({
    ...
    EditableText.prototype.SingleUpload = function (ImageId, selectedDiv, IsImageTag, IsDynamicControl) {
    ...
    EditableText.prototype.UploadVideo = function (ImageId, selectedDiv, mediaPath) {
    ...
    EditableText.prototype.UploadAudio = function (ImageId, selectedDiv, mediaPath) {
        $("input#" + ImageId).val(selectedDiv.split('_')[1]);
        var div = $('#Upload' + ImageId);
        var selectedFileName = EditableText.prototype.GetSelectedFileName(selectedDiv);
    ...
    EditableText.prototype.UploadFile = function (ImageId, selectedDiv, mediaPath) {
        $("input#" + ImageId).val(selectedDiv.split('_')[1]);
        var div = $('#Upload' + ImageId);
        var selectedFileName = EditableText.prototype.GetSelectedFileName(selectedDiv);
    ...
    EditableText.prototype.UploadImage = function (ImageId, selectedDiv, mediaPath) {
    ...
    EditableText.prototype.ValidateImage = function (ImageId, selectedDiv, IsImageTag, IsDynamicControl) {
    ...
    EditableText.prototype.MultipleUpload = function (DivId, IsImageTag) {
        var ids = new Array();
    ...
    EditableText.prototype.UploadMultipleImage = function (ids, attributeName, isAnyFileExist) {
    ...
    EditableText.prototype.UploadMultipleFiles = function (ids, DivId, isAnyFilesExist) {
    ...
    EditableText.prototype.GetMultipleUploadFiles = function (controlName) {
    ...
    EditableText.prototype.GetMediaExtention = function (fileSource) {
        var uploadFileType;
    ...
    EditableText.prototype.CancelUpload = function () {
        $("#appendDiv").slideUp(200, function () {
            $("#appendDiv").hide(5);
            $(this).remove();
    ...
    EditableText.prototype.RemoveImage = function (ImageId) {
        $("#" + ImageId).attr('src', '');
    ...
    EditableText.prototype.RemoveMultipleImage = function (ImageId) {
    ...
    EditableText.prototype.RemoveMultipleFiles = function (fileId) {
    ...
    EditableText.prototype.ValidateExtentions = function (ImageId, fileName) {
    ...
    EditableText.prototype.ValidateFileSize = function (ImageId, mediaSize) {
    ...
    EditableText.prototype.RemoveMedia = function (MediaId) {
        $("div#" + MediaId).html('');
        $("input#" + MediaId).val('');
    };
    EditableText.prototype.StrikeOutQueryString = function (url) {
        return url.split("?")[0].split("#")[0];
    };
    EditableText.prototype.IsFileAlreadyUploaded = function (imageId, uploadImageId) {
    ...
    EditableText.prototype.GetSelectedFileName = function (selectedDiv) {
